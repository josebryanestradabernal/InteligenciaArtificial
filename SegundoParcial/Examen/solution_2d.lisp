  ...
  (let* (
    ...
    (case movF
      ( :Arriba
       ...
       ( :Arriba-Derecha 
         (if  (and (> row 0 ) (< col colL)) 
        (progn 
        (setq cel1 (get-cell-walls  row  (1+ col)) )
        (setq cel2 (get-cell-walls (1- row) col ))
        (if (or (and (= 0 (logand wall 2)) (= 0 (logand cel1 1)) )
                (and (= 0 (logand wall 1)) (= 0 (logand cel2 2)) )       
            )
            T 
            nil 
            )
      ...
      ( :Derecha
       ...
       ( :Abajo-Derecha 
          (if  (and (< row rowL ) (< col colL)) 
        (progn 
        (setq cel1 (get-cell-walls  row  (1+ col)) )
        (setq cel2 (get-cell-walls (1+ row) col ))
        (if (or (and (= 0 (logand wall 2)) (= 0 (logand cel1 4)) )
                (and (= 0 (logand wall 4)) (= 0 (logand cel2 2)) )       
            )
            T 
            nil 
            )
      ...
      ( :Abajo
       ...
       ( :Abajo-Izquierda
        (if  (and (< row rowL ) (> col 0)) 
        (progn 
        (setq cel1 (get-cell-walls  row  (1- col)) )
        (setq cel2 (get-cell-walls (1+ row) col ))
        (if (or (and (= 0 (logand wall 8)) (= 0 (logand cel1 4)) )
                (and (= 0 (logand wall 4)) (= 0 (logand cel2 8)) )       
            )
            T 
            nil 
            )
      ...
      ( :Izquierda
       ...
       ( :Arriba-Izquierda 
        ...
        (setq cel1 (get-cell-walls  row  (1- col)) )
        (setq cel2 (get-cell-walls (1- row) col ))
        (if (or (and (= 0 (logand wall 8)) (= 0 (logand cel1 1)) )
                (and (= 0 (logand wall 1)) (= 0 (logand cel2 8)) )       
            )
            T 
            nil 
            )
